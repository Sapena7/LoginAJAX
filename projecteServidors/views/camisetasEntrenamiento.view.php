...
<!-- Search Panel -->
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(images/camisetasEntrenamientoBanner.jpg)"></div>
			<div class="home_content_container">
				<div class="container">
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Camisetas entrenamiento<span>.</span></div>
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="col">
                        ...
                        foreach ($products as $product) {
                            ...
                            <div class="product">
                                <div class="product_image">
                                    <img src="images/camisetasEntrenamiento/<?php echo $product->getImg();?>" alt=""></div>
                    ...
                    <div class="product_pagination">
                        <ul>
                            <?php
                            if ($previous!=0){ ?>
                                <li class="active"><a href="index.php?page=camisetasEntrenamiento&pages=<?= $previous . $categoria . $fechaMin . $fechaMax . $textFilter;?>">Previous</a></li>
                            <?php }
                            ?>

                            <?php
                            for ($i = 1; $i<=$pages; $i++){?>
                                <li class="active"><a href="index.php?page=camisetasEntrenamiento&pages=<?= $i . $categoria . $fechaMin . $fechaMax . $textFilter;?>"><?=$i?></a></li>
                                <?php
                            }
                            ?>
                            <?php
                            if ($next<=$pages){ ?>
                                <li class="active"><a href="index.php?page=camisetasEntrenamiento&pages=<?= $next . $categoria . $fechaMin . $fechaMax . $textFilter;?>">Next</a></li>
                            <?php }?>
